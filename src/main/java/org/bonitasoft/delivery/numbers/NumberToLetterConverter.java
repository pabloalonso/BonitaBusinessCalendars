package org.bonitasoft.delivery.numbers;
...
public abstract class NumberToLetterConverter {
    ...
    public static String formatLempiras(long importe){
		NumberFormat formatoImporte = NumberFormat.getCurrencyInstance();
		formatoImporte = NumberFormat.getCurrencyInstance(new Locale("es","HN"));
